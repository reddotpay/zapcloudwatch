...
func NewCloudwatchHook(groupName, streamName string, isAsync bool, cfg *aws.Config) Interface {
...
func example() {
	cfg := &aws.Config{}
	hook, _ := NewCloudwatchHook("loggroupname", "logstream", true, cfg).GetHook()
